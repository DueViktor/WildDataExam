...
fig = px.line(
    btc, x="Date", y=["Close", "RollingClose"], title="BTC Close and Rolling Close"
)

# 1.
fig.add_vrect(
    x0="2022-03-05", x1="2022-04-04", fillcolor="blue", opacity=0.25, line_width=0
)
...
# 2.
fig.add_vrect(
    x0="2022-01-27", x1="2022-02-16", fillcolor="blue", opacity=0.25, line_width=0
)
...
# 3.
fig.add_vrect(
    x0="2022-02-23", x1="2022-03-07", fillcolor="blue", opacity=0.25, line_width=0
)
fig.add_vline(x="2022-02-03", line_width=1, line_dash="dash", line_color="black")
...
# 4.
fig.add_vrect(
    x0="2022-06-01", x1="2022-07-01", fillcolor="red", opacity=0.25, line_width=0
)
...
# 5.
fig.add_vrect(
    x0="2022-04-27", x1="2022-05-19", fillcolor="red", opacity=0.25, line_width=0
)
...
# 6.
fig.add_vrect(
    x0="2022-01-12", x1="2022-01-30", fillcolor="red", opacity=0.25, line_width=0
)
